package br.com.xfrontier.housekeeper.core.services.token.providers;
...
import br.com.xfrontier.housekeeper.core.services.token.exceptions.TokenServiceException;
...
public class JjwtService implements TokenService {
    ...
    @Value("${br.com.xfrontier.housekeeper.access.key}")
    private String accessKey;

    @Value("${br.com.xfrontier.housekeeper.access.expiration}")
    private int accessExpiration;

    @Value("${br.com.xfrontier.housekeeper.refresh.key}")
    private String refreshKey;

    @Value("${br.com.xfrontier.housekeeper.refresh.expiration}")
